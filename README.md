...
- 21살
- 첨단컴퓨팅학부 인공지능학과
- Letterboxd 영화 리뷰 크롤링과 전처리, EDA/FE 및 키워드 비교분석을 담당했습니다.

### 최은채

- 24살
- 경영학과전공
- 메타크리틱 영화 리뷰 크롤링과 전처리, EDA/FE 및 사이트 리뷰 길이 비교분석을 담당했습니다.
...
Web 과제는 FastAPI 기반으로 구현되어 있으며, 프로젝트 루트 디렉토리에서 의존성을 설치한 뒤 실행합니다.
...
database/reviews_letterboxd.csv
database/reviews_metacritic.csv
```
